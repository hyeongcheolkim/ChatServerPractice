...
static constexpr ::PROTOBUF_NAMESPACE_ID::Metadata* file_level_metadata_ClientRequest_2eproto = nullptr;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ClientRequest_2eproto::offsets[1] = {};
static constexpr ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema* schemas = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::Message* const* file_default_instances = nullptr;

const char descriptor_table_protodef_ClientRequest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023ClientRequest.proto"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ClientRequest_2eproto = {
  &descriptor_table_ClientRequest_2eproto_initialized, descriptor_table_protodef_ClientRequest_2eproto, "ClientRequest.proto", 21,
  &descriptor_table_ClientRequest_2eproto_once, descriptor_table_ClientRequest_2eproto_sccs, descriptor_table_ClientRequest_2eproto_deps, 0, 0,
  schemas, file_default_instances, TableStruct_ClientRequest_2eproto::offsets,
  file_level_metadata_ClientRequest_2eproto, 0, file_level_enum_descriptors_ClientRequest_2eproto, file_level_service_descriptors_ClientRequest_2eproto,
};
