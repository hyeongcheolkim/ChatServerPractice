...
// uint64 val = 1;
inline void ChatMessage::clear_val() {
  val_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChatMessage::_internal_val() const {
  return val_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 ChatMessage::val() const {
  // @@protoc_insertion_point(field_get:Protocol.ChatMessage.val)
  return _internal_val();
}
inline void ChatMessage::_internal_set_val(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  val_ = value;
}
inline void ChatMessage::set_val(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_val(value);
  // @@protoc_insertion_point(field_set:Protocol.ChatMessage.val)
}
